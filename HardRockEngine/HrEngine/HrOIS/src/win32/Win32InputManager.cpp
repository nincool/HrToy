...
void Win32InputManager::_parseConfigSettings( ParamList &paramList )
{
	...
	temp["DISCL_BACKGROUND"]	= DISCL_BACKGROUND;//允许窗口以后台方式访问设备
	temp["DISCL_EXCLUSIVE"]		= DISCL_EXCLUSIVE;//独占模式
	temp["DISCL_FOREGROUND"]	= DISCL_FOREGROUND;//只能以前台方式访问设备
	temp["DISCL_NONEXCLUSIVE"]	= DISCL_NONEXCLUSIVE;//非独占模式
	temp["DISCL_NOWINKEY"]		= DISCL_NOWINKEY;//不使用Windows键
