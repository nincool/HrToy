...
class CPrefabModelToolBar : public CMFCToolBar
{
...
class HrPrefabModelView : public CDockablePane, public HrViewTreeListener
{
public:
	HrPrefabModelView();
	virtual ~HrPrefabModelView();
	...
	virtual void OnViewTreeLBtnDown(HTREEITEM hitItem) override;
protected:
	CPrefabModelToolBar m_wndToolBar;
