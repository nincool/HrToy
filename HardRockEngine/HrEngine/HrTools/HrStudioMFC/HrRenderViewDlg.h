...
public:
	HrRenderViewDlg(HrPrefabModelView* pPrefabModelView = nullptr, CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	...
	void OnOpenPrefab(const std::string& strFile);
protected:
...
private:
	...
	HrPrefabModelView* m_pPrefabModelView;
